	...
	$.fn.fullpage = function(options) {
		...
		*/
		...
		$.fn.fullpage.moveSectionUp = function(){
			...
			if($('.fp-section.active').attr('id') == "section3"){
				$("#chevron-down").toggleClass('hidden');
				$("#chevron-down").toggleClass('visible');
			}
			if(prev.attr('id') == "section0"){
				$("#chevron-up").toggleClass('hidden');
				$("#chevron-up").toggleClass('visible');
				$('#chevron-down').css( "color", "#792221" );
				$('.copy').css( "color", "#792221" );	
			}
		...
		$.fn.fullpage.moveSectionDown = function (){
			...
			if($('.fp-section.active').attr('id') == "section0"){
				$("#chevron-up").toggleClass('hidden');
				$("#chevron-up").toggleClass('visible');
				$('#chevron-up').css( "color", "#F6F5F0" );
				$('#chevron-down').css( "color", "#F6F5F0" );
				$('.copy').css( "color", "#F6F5F0");
			}
			if(next.attr('id') == "section3"){
				$("#chevron-down").toggleClass('hidden');
				$("#chevron-down").toggleClass('visible');
			}
