...
c+'"]').addClass("active"):a("#fp-nav").find("li").eq(d).find("a").addClass("active"))}function M(c){b.menu&&(a(b.menu).find(".active").removeClass("active"),a(b.menu).find('[data-menuanchor="'+c+'"]').addClass("active"))}function C(c,a){if("top"===c)return!a.scrollTop();if("bottom"===c)return a.scrollTop()+1+a.innerHeight()>=a[0].scrollHeight}function G(c){var b=a(".fp-section.active").index(".fp-section");c=c.index(".fp-section");return b>c?"up":"down"}function z(a){a.css("overflow","hidden");var d=
...
function(a){b.scrollingSpeed=a};a.fn.fullpage.setMouseWheelScrolling=function(a){a?document.addEventListener?(document.addEventListener("mousewheel",n,!1),document.addEventListener("wheel",n,!1)):document.attachEvent("onmousewheel",n):document.addEventListener?(document.removeEventListener("mousewheel",n,!1),document.removeEventListener("wheel",n,!1)):document.detachEvent("onmousewheel",n)};a.fn.fullpage.setAllowScrolling=function(b){b?(a.fn.fullpage.setMouseWheelScrolling(!0),J&&(MSPointer=ba(),
a(document).off("touchstart "+MSPointer.down).on("touchstart "+MSPointer.down,ea),a(document).off("touchmove "+MSPointer.move).on("touchmove "+MSPointer.move,da))):(a.fn.fullpage.setMouseWheelScrolling(!1),J&&(MSPointer=ba(),a(document).off("touchstart "+MSPointer.down),a(document).off("touchmove "+MSPointer.move)))};a.fn.fullpage.setKeyboardScrolling=function(a){b.keyboardScrolling=a};var p=!1,J=navigator.userAgent.match(/(iPhone|iPod|iPad|Android|BlackBerry|BB10|Windows Phone|Tizen|Bada)/),h=a(this),
l=a(window).height(),t=!1,D=!1,v,H,T="fullpage-wrapper";a.fn.fullpage.setAllowScrolling(!0);b.css3&&(b.css3=ha());a(this).length?(h.css({height:"100%",position:"relative","-ms-touch-action":"none"}),h.addClass(T)):console.error("Error! Fullpage.js needs to be initialized with a selector. For example: $('#myContainer').fullpage();");a(b.sectionSelector).each(function(){a(this).addClass("fp-section")});a(b.slideSelector).each(function(){a(this).addClass("fp-slide")});if(b.navigation){a("body").append('<div id="fp-nav"><ul></ul></div>');
...
b.navigation&&(m.css("margin-top","-"+m.height()/2+"px"),m.find("li").eq(a(".fp-section.active").index(".fp-section")).find("a").addClass("active"));b.menu&&b.css3&&a(b.menu).closest(".fullpage-wrapper").length&&a(b.menu).appendTo("body");b.scrollOverflow?(h.hasClass("fullpage-used")&&K(),a(window).on("load",K)):a.isFunction(b.afterRender)&&b.afterRender.call(this);c=window.location.hash.replace("#","").split("/")[0];c.length&&(d=a('[data-anchor="'+c+'"]'),!b.animateAnchor&&d.length&&(b.autoScrolling?
u(d.position().top):(u(0),a("html, body").scrollTop(d.position().top)),a.isFunction(b.afterLoad)&&b.afterLoad.call(this,c,d.index(".fp-section")+1),d.addClass("active").siblings().removeClass("active")));a(window).on("load",function(){var a=window.location.hash.replace("#","").split("/"),b=a[0],a=a[1];b&&I(b,a)})});var O,F=!1;a(window).on("scroll",L);var x=0,B=0,w=0,A=0;a.fn.fullpage.moveSectionUp=function(){var c=a(".fp-section.active").prev(".fp-section");c.length||!b.loopTop&&!b.continuousVertical||
(c=a(".fp-section").last());c.length&&k(c,null,!0)};a.fn.fullpage.moveSectionDown=function(){var c=a(".fp-section.active").next(".fp-section");c.length||!b.loopBottom&&!b.continuousVertical||(c=a(".fp-section").first());(0<c.length||!c.length&&(b.loopBottom||b.continuousVertical))&&k(c,null,!1)};a.fn.fullpage.moveTo=function(b,d){var e="",e=isNaN(b)?a('[data-anchor="'+b+'"]'):a(".fp-section").eq(b-1);"undefined"!==typeof d?I(b,d):0<e.length&&k(e)};a.fn.fullpage.moveSlideRight=function(){R("next")};
